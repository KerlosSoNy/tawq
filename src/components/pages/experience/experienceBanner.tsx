    ...
    return (
        <motion.div
            ...
            <div className="ps-3 md:ps-10 xl:ps-18 flex flex-col relative z-10">
                <motion.div variants={mainTitle} className="text-[44px] md:text-[60px] lg:text-[80px] 2xxl:text-[120px] 3xl:text-[146px] font-galderglynn w-fit font-bold text-white leading-none tracking-tight">
                    Embrace the
            ...
            <video
                src="/videos/experienceBanner.mp4"
                autoPlay
                loop
                muted
