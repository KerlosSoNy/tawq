...
export default function Packages() {
    ...
    return (
        <motion.div
            ...
            className="min-h-270 relative pt-80 max-w-full overflow-hidden -mb-20 flex flex-col items-center">
            ...
            <motion.span variants={mainTitle} className="font-galderglynn packages-text absolute left-1/2 -translate-x-1/2 top-4  w-fit  font-bold text-[300px] z-1">
                Packages
            </motion.span>
            <div className="flex flex-row gap-28 relative z-20 items-start">
                <div className="flex flex-col max-w-134.5 pt-36">
                    ...
                    <motion.span variants={subTitle} className="font-bold font-galderglynn text-1 mt-8 text-black">
                        Unique Experiences
                    </motion.span>
                    <motion.span variants={smallDescription} className="text-5 text-neutral-600 leading-8 mt-8 font-light">
                    ...
                    <motion.button variants={button} className="relative w-59 h-14  flex items-center mt-8 rounded-sm gap-1.5 justify-center border border-primary-100 overflow-hidden group cursor-pointer ">
