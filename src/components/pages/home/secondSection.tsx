...
export default function SecondSection() {
    ...
    return (
        <motion.div className="flex flex-col px-20 relative z-7 mt-30">
            <div className="px-[43.5px] flex flex-row items-start justify-between">
                ...
                <div className="flex flex-col text-[128px] font-galderglynn text-white leading-32">
                    ...
                    <motion.span variants={title} key="title2" className="ms-45">adventure</motion.span>
                </div>
            </div>
            <div className="w-full grid grid-cols-3 gap-17 mt-16">
                ...
                <div className="flex flex-col w-full items-center">
                    <div className="flex flex-col mb-11">
                        <motion.span variants={subTitle} className="max-w-85.25 text-white text-5 leading-8">
