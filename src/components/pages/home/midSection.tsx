...
export default function MidSection() {
    ...
    return (
        <motion.div
            ...
            className="w-full min-h-329 relative pt-10 bg-secondary2-400  -mt-px">
         ...
         z-4" />
            ...
            />
            <div className="flex flex-col w-full z-10 relative px-[81.5px]">
                <motion.span variants={hiddenTitle} className="font-galderglynn  w-fit opacity-[0.4] mix-blend-plus-lighter  font-bold text-[164px] faqs-text z-2">
                    Why Choose Twaq
                </motion.span>
                <div className="flex flex-row items-center justify-between px-[227.5px] mt-16">
                    <motion.span variants={title} className="max-w-182.25 text-1 font-galderglynn font-bold text-white">We transform spaces into worlds</motion.span>
                    <motion.span variants={subTitle} className="max-w-101.5 text-5 text-white ">
                ...
                <div className="h-145.5 grid grid-cols-4 gap-6 mt-24">
                    <div className="grid grid-rows-2 col-span-2 gap-6 h-full w-full">
            ...
            <svg className="absolute -bottom-14.5 left-0" width="1920" height="99" viewBox="0 0 1920 99" fill="none" xmlns="http://www.w3.org/2000/svg">
