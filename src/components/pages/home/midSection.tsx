...
export default function MidSection() {
    return (
        <div className="w-full min-h-329 relative pt-10 bg-secondary2-400  -mt-px">
         ...
         z-4" />
            ...
            <div className="flex flex-col w-full z-10 relative px-[81.5px]">
                <span className="font-galderglynn  w-fit opacity-[0.4] mix-blend-plus-lighter  font-bold text-[164px] faqs-text z-2">
                    Why Choose Twaq
                </span>
                <div className="flex flex-row items-center justify-between px-[227.5px] mt-16">
                    <span className="max-w-182.25 text-1 font-galderglynn font-bold text-white">We transform spaces into worlds</span>
                    <span className="max-w-101.5 text-5 text-white ">
