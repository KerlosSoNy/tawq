        ...
        <motion.div variants={mainForm} className='w-full md:mx-auto lg:mx-0 md:w-130 xl:w-140 h-fit md:h-158 bg-white/25 flex flex-col gap-5 backdrop-blur-lg p-3 md:p-8'>
            ...
            <div className="rounded-sm border border-neutral-400 h-14 bg-white p-6 gap-2.5 flex flex-row items-center">
                <svg className="shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 9.00005L10.2 13.65C11.2667 14.45 12.7333 14.45 13.8 13.65L20 9" stroke="#A4A4A4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M3 9.17681C3 8.45047 3.39378 7.78123 4.02871 7.42849L11.0287 3.5396C11.6328 3.20402 12.3672 3.20402 12.9713 3.5396L19.9713 7.42849C20.6062 7.78123 21 8.45047 21 9.17681V17C21 18.1046 20.1046 19 19 19H5C3.89543 19 3 18.1046 3 17V9.17681Z" stroke="#A4A4A4" stroke-width="1.5" stroke-linecap="round" />
                </svg>
